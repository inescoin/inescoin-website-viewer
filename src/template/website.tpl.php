        ...
        <ul class="navbar-nav ml-auto my-2 my-lg-0">
          <?php foreach ($domain['pages'] as $page): ?>
            <?php if ($page['shownInMenu'] && !empty($page['menuTitle']) && !$page['isLink']) : ?>
              <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#<?php echo $page['divId']; ?>"><?php echo $page['menuTitle']; ?></a></li>
            <?php endif; ?>
            <?php if (isset($page['isLink']) && $page['isLink']) : ?>
              <li class="nav-item"><a class="nav-link js-scroll-trigger" target="blank" href="<?php echo $page['linkUrl']; ?>"><?php echo $page['menuTitle']; ?></a></li>
            <?php endif; ?>
          <?php endforeach; ?>
          ...
          <li class="nav-item dropdown">
            <a class="nav-item nav-link dropdown-toggle mr-md-2" href="#" id="bd-versions" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><?php echo $domain['label']; ?></a>
